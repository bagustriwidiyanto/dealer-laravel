...
<div class="container-fluid">
    ...
    if(isset($_POST["submit"])){
        ...
        $alamat = $_POST["alamat"];
        $no = $_POST["notelp"];
    $create = mysqli_query($koneksi,"insert into pelanggan(nama,jenis_kelamin,alamat,notelp) values ('$nama','$jk','$alamat','$no')");
    } ?>
                        <?php
                        ...
                        if (isset($_POST['edit'])){
                            ...
                            $jk = $_POST['jk'];
                            $notelp = $_POST['notelp'];
                            $update = mysqli_query($koneksi, "update pelanggan set id='$id', nama='$nama', jenis_kelamin='$jk',alamat='$alamat',notelp='$notelp' where id='$id'") or die("error query");
                        if ($update){
                    ...
                    <center><a href="index.php?module=pelanggan-create" class="btn" role="button">+ Create New +</a>
                </div>
            </div>
        </div>
    </div>
